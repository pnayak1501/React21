...
const App = () => {
  ...
  const checkIsWinner = () =>{
    if(itemArray[0] === itemArray[1] && itemArray[1] === itemArray[2] && itemArray[0] !=="empty"){
      ...
      setWinMessage(`${itemArray[2]} wins`)
    }else if(itemArray[0]!=="empty"&&itemArray[1]!=="empty"&&itemArray[2]!=="empty"&&itemArray[3]!=="empty"&&itemArray[4]!=="empty"&&itemArray[5]!=="empty"&&itemArray[6]!=="empty"&&itemArray[7]!=="empty"&&itemArray[8]!=="empty"&&winMessage===""){
      setWinMessage("draw")
    }
  }
  ...
  const changeItem = (itemNumer) =>{
    ...
    if(itemArray[itemNumer] === "empty"){
      itemArray[itemNumer] = isCross ? "cross" : "circle";
      setIsCross(!isCross)
    }else{
